...
public class UserDao implements BaseDao {
	...
	/*
	 * //Struts2 2.5.10.1 + Hibernate 5.2.10 集成所用代码 private Session session;
	 * 
	 * @Override public Session getSession() { return session; }
	 * 
	 * @Override public void setSession(Session session) { this.session =
	 * session; }
	 * 
	 * @Override public void saveObject(Object obj) throws HibernateException {
	 * session.save(obj); }
	 */
